...
export default function OnboardingProgressTracker() {
  ...
  const phases = [
    ...
    },
    {
      ...
      steps: [
        ...
        { id: 6, name: "Service Agreement", group: "final", completed: false },
      ],
    },
    {
      name: "Final Review",
  ...
  const [activePhase, setActivePhase] = useState(-1); // Default to Platform Setup phase
  ...
  // Standard step renderer for non-Platform Setup phases
  const renderStepCircle = (step, idx) => {
    ...
    return (
      <div
        key={idx}
        onClick={() => setActiveStepIndex(idx)} // Always allow click
  ...
  // Group steps by their type for Platform Setup phase
  const groupSiteSetupSteps = steps => {
    const groups = {
  ...
  // Customer Success Manager step renderer for Platform Setup phase with horizontal flow
  const renderSiteSetupFlow = steps => {
    const groups = groupSiteSetupSteps(steps);
  ...
  // Customer Success Manager step renderer for Analysis phase with horizontal flow
  const renderAnalysisFlow = steps => {
    const groups = {
      current: steps.filter(step => step.group === "Current Setup"),
      company: steps.filter(step => step.group === "Our Recommendation"),
      next: steps.filter(step => step.group === "Next"),
    };

    return (
      <div className="mb-6">
        <div className="flex border-b border-gray-300 mb-2">
          {Object.entries(groups).map(([key, groupSteps]) => {
            const meta = analysisGroupMeta[key];
            return (
              <div
                key={key}
                className="flex-1 px-2 py-1 text-center rounded-t-lg border-t border-l border-r border-gray-300"
                style={{ backgroundColor: meta.bg }}
              >
                <h3 className={`font-medium ${meta.text} text-sm`}>
                  {meta.label}
                </h3>
              </div>
            );
        ...
        <div className="flex items-center relative h-24">
          ...
          {Object.entries(groups).map(([key, groupSteps]) => {
            const meta = analysisGroupMeta[key];
            return (
              <div key={key} className="flex-1 flex justify-around">
  ...
  // Current step panel (shows only for Platform Setup phase)
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
        ...
        <div className="ml-11">
          <p className="text-gray-600 text-sm mb-2">
            Complete this step to proceed with your setup.
          </p>
          <button
  ...
  return (
    <div className="w-full mx-auto bg-white rounded-lg p-8">
      ...
      {activePhase >= 0 &&
        (activePhase === 2
          ? // Customer Success Manager horizontal flow for Platform Setup phase
      ...
      {activePhase === -1 && (
        <div className="space-y-6 bg-white p-6 rounded shadow max-w-3xl">
          ...
          <p className="text-gray-800">
            ...
            support from your dedicated account team, will guide you through
            each step to help you get up and running smoothly.
          </p>
          ...
          <div className="pl-6">
            ...
            <p>
              Your access is tied to your Google account. To keep your data
              secure, we recommend enabling 2-step verification (2FA). It only
              takes a few minutes and adds an important layer of protection
            ...
            <table className="min-w-full text-sm text-left text-gray-800 border-collapse">
              <thead className="bg-gray-100 text-xs uppercase font-semibold">
                <tr>
                  ...
                  <th className="px-4 py-2">Creator Average</th>
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>Audience insights: Creator-grade intelligence</li>
      ...
      {activePhase === 1 && activeStepIndex === 3 && (
        <div className="space-y-6">
          ...
          <p>
            ...
            advanced creator tools. Once your enhanced dashboard is live, you'll
            have full control to fine-tune any settings through your creator
            control panel.
          </p>
          <p>
            ...
            dedicated creator success team will provide ongoing support and
          ...
          <div className="space-y-6">
            ...
            <div className="requirements">
              ...
              <ul className="list-disc pl-5 text-sm text-gray-700">
                <li>
                  Link to privacy policy must be accessible from your main
                  navigation
                </li>
                <li>
                  Terms of service must be clearly displayed and accepted by
                  users
                </li>
                <li>
      ...
      {activePhase === 2 &&
        ...
        calculateCompletion(phaseData[2]) < 100 && (
          <div className="space-y-6">
            ...
            <ul className="list-disc pl-5">
              <li>
                Payment method details (credit card, bank account, or corporate
                payment system)
              </li>
              <li>
      ...
      {activePhase === 2 &&
        ...
        calculateCompletion(phaseData[2]) < 100 && (
          <div className="space-y-6">
            ...
            <p>
              Below are some highlights from our Service Agreement (the full and
              binding description can be found in the complete Service
              Agreement):
            </p>
            <p>
              <strong>Service Level:</strong> We commit to providing the
              agreed-upon service levels including uptime guarantees and
              response times.
            </p>
            <p>
            ...
            <p>
              <strong>Service Terms:</strong> Should you choose to terminate
              your service, standard notice periods apply as outlined in the
              full agreement.
            </p>
            <p>
              Sign our service agreement using the button below. We'll send you
              a copy by email.
            </p>
            <div className="flex justify-end mt-6">
              <button
      ...
      {activePhase === 3 && activeStepIndex === 3 && (
        <div className="space-y-6">
          ...
          <p>
            ...
            automatically enrolled in our premium creator revenue suite with all
            the features we've discussed. Your enhanced creator dashboard will
            be live within 24 hours, giving you complete control over your
            monetization settings.
          </p>
          <p>
            Your dedicated creator success manager will reach out within 48
        ...
        >
          <div className="flex items-start space-x-3">
            ...
            >
              ...
              ready for launch! Keep an eye out for another email from your
              Customer Success Manager with information about what to expect on
              your launch date and moving forward.
            </span>
          </div>
